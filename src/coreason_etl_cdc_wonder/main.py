...
def run_pipeline() -> None:
    ...
    try:
        ...
        # Target matching standardized Bronze table naming
        query = "SELECT raw_data FROM bronze.coreason_etl_cdc_wonder_bronze_cdc_wonder_mortality_raw"
        ...
        # Target matching standardized Silver table naming
        df_silver.write_database(
            table_name="silver.coreason_etl_cdc_wonder_silver_cdc_wonder_mortality",
            connection=uri,
